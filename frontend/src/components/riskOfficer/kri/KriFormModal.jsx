  ...
  const handleSubmit = async () => {
    ...
    if (!editingKri) {
      ...
      if (
        ...
        toast.error(
          "This Risk already has a KRI. You cannot create another KRI for the same Risk."
        );
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-4 px-6 py-5 sm:grid-cols-2">
              ...
              {selectedRiskAlreadyHasKri &&
                !editingKri && (
                  <div className="sm:col-span-2 flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 p-3">
                    <FiAlertTriangle
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-amber-600">
                        You cannot create another KRI for the same Risk.
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div className="sticky bottom-0 flex justify-end gap-2 border-t border-slate-100 bg-white/95 px-6 py-4 backdrop-blur">
              ...
              <motion.button
                ...
                className="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-md shadow-indigo-200 transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {saving
                  ? "Saving..."
                  : editingKri
