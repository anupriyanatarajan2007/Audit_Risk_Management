...
export default function AuditManager() {
  ...
  const loadUsers = async () => {
    ...
    try {
      ...
      console.log(
        "FULL AUDIT MANAGER API RESPONSE:",
        response
      );
      ...
      if (err?.response?.status === 403) {
        setError(
          "Access Denied - You don't have permission to view Audit Managers"
        );
  ...
  return (
    <div className="p-8 bg-slate-50 min-h-screen">
      ...
      <div className="relative mb-6 w-full md:w-96">
        ...
        <input
          type="text"
          placeholder="Search Audit Manager..."
          value={search}
          onChange={(e) =>
            ...
            <tbody>
              ...
              {loading ? (
                ...
                <tr>
                  ...
                  >
                    {search
                      ? "No matching Audit Manager found"
                      : "No Audit Manager Found"}
                  </td>
                </tr>
