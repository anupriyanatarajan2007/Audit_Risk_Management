  ...
  const loadUsers = async () => {
    ...
    try {
      ...
      if (error?.response?.status === 403) {
        setError(
          "Access Denied - You don't have permission to view System Administrators"
        );
      } else if (
        ...
        setError(
          "Unable to load System Administrators"
        );
      }
    } finally {
      setLoading(false);
  ...
  return (
    <div className="p-8 bg-slate-50 min-h-screen">
      ...
      <div className="relative mb-6 w-96">
        ...
        <input
          type="text"
          placeholder="Search System Administrator..."
          value={search}
          onChange={(e) =>
