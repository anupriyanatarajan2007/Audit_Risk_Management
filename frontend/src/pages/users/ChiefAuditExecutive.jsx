...
export default function ChiefAuditExecutive() {
    ...
    try {
      ...
      */
      ...
      if (
        ...
        setError(
          "Access Denied - You don't have permission to view Chief Audit Executives"
        );
      } else if (
        ...
        setError(
          "Unable to load Chief Audit Executives"
        );
      }
    } finally {
      setLoading(false);
  ...
  /* =========================================================
     ...
     Supports both object and string department.
  ========================================================= */
    ...
    <div className="p-8 bg-slate-50 min-h-screen">
      ...
      >
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Manage Chief Audit Executive Users
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <StatCard
          ...
          iconBg="bg-blue-50"
          label="Total Chief Audit Executives"
          value={totalCount}
        />
      ...
      <div className="relative mb-6 w-96">
        ...
        <input
          type="text"
          placeholder="Search Chief Audit Executive..."
          value={search}
          onChange={(e) =>
              ...
              {loading ? (
                ...
                <tr>
                  <td
                    ...
                    className="text-center py-10 text-slate-400"
                  >
                    No Chief Audit Executive Found
                  </td>
                </tr>
