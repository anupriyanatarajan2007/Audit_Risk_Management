...
const formatDepartment = (dept) => {
  ...
  // Backend returns department object
  // {
  //   id: 1,
...
export default function Auditee() {
  ...
  const loadUsers = async () => {
    ...
    try {
      const response = await getUsersByRole("AUDITEE");
      ...
      */
      ...
      /*
        Handles JSON string response
      */
      if (typeof usersData === "string") {
        usersData = JSON.parse(usersData);
      }

      console.log("FINAL AUDITEE DATA:", usersData);
      ...
      console.error("LOAD AUDITEES ERROR:", err);
      ...
      if (err?.response?.status === 403) {
        setError(
          "Access Denied - You don't have permission to view Auditees"
        );
        ...
        setError("Unable to load Auditees");
      }
    } finally {
      setLoading(false);
    }
  ...
  const handleDelete = async (user) => {
    ...
    /*
      Connect your actual DELETE API here.
